...
async def main():
    async with async_playwright() as p:
        ...
        filepath = os.path.abspath("Weekly_Meeting_9.html")
        ...
        output_path = os.path.abspath("../Team22 - Weekly Meeting/team22_Weekly_Meeting_9.pdf")
        ...
        await browser.close()
        print("✅ team22_Weekly_Meeting_9.pdf generated successfully.")
